...
<body style="padding:0;margin:0;font-family: arial, sans-serif;">
  ...
  <div id="feeds">
    ...
    <div>
    <div style="float:left;" ><h2 align="left">Recieved Messages</h2></div>
  <div style="float:right;margin-right:15px;"><a  href='view_sent.php'><button class="subButton"><b>Check Sentbox</b></button></a></div>
    <br><br><br>
  </div>
  <br>
    <?php

      $sql="SELECT User.ID,timestamp,reciever,name,text FROM message,User WHERE reciever='".$_SESSION['user_id']."' AND message.sender=User.ID ORDER BY message.ID DESC";
